...
Here is a link to the official repository at the point it was forked
https://github.com/heroku/heroku-buildpack-nodejs/tree/e7a4fff9225693bd7fa417a8a9052533f702795b

Changes from the official version
Removed vendor/shunit2
Removed vendor/test-utils
Reimplemented bin/test to be a ruby script 
Modify bin/compile to look at BUILDPACK_CACHE or Bluemix file server
Add test to check v0.10.21 specifically (an IBM version of Node)
